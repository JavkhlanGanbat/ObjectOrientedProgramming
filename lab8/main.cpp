...
void displayShapes() {
    ...
    cout << Shape::getObjCount() << " Objects exist" <<  endl << endl;
}
...
void deleteShapeObject() {
    int del;
    cout << "Index of object to delete: ";
    cin >> del;

    if (del < 1 || del > shapes.size()) {
        cout << "Out of bounds.\n";
        return;
    }
